...
export default class {
  ...
  handleEditTicket(e, bill, bills) {
    ...
    // Initialize the counter and currentBillId variables
    let counter = 0;
    let currentBillId = undefined;

    // If the currentBillId is not the same as the ID of the clicked bill, reset the counter and currentBillId
  ...
  handleShowTickets(e, bills, index) {
    ...
    let counter = 0;
    let currentBillIndex = undefined;

    if (currentBillIndex !== index) {
      counter = 0;
